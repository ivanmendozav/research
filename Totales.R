...
#Histograma 
#EDAD
histograma<-hist(bicis$Edad, main=" ", col="#A4D3EE", ylim=c(0,150), xlab="Edad(años)",ylab="Frecuencia", breaks = 8, xaxt = "n" )
...
#Velocidad
histograma<-hist(bicis$Vel_prom, main="Velocidad Promedio", col="#A4D3EE", ylim=c(0,60), xlab="Velocidad (km/h)", breaks =15 , xaxt = "n")
