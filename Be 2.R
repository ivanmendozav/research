...
#Velocidad
histograma<-hist(bicis$Vel_prom, main="BE Velocidad Promedio", col="#FFE1FF", ylim=c(0,20), xlab="Velocidad (km/h)",ylab="Frecuencia", breaks =15 , xaxt = "n")
...
#Aceleración
histograma<-hist(bicis$aceleración_promedio, main="BE Aceleración Promedio", col="#DDA0DD", ylim=c(0,40), xlab="Aceleración (m/s²)",ylab="Frecuencia",  breaks = 10, xaxt = "n")
...
#Tiempo
histograma<-hist(bicis$Tiempo, main="BE Tiempo de recorrido", col="#A4D3EE", ylim=c(0,30), xlab="Tiempo (min)",ylab="Frecuencia", breaks = 15, xaxt = "n")
