...
#Velocidad
histograma<-hist(bicis$Vel_prom, main="BP Velocidad Promedio", col="#FFE1FF", ylim=c(0,30), xlab="Velocidad (km/h)",ylab="Frecuencia", breaks =15 , xaxt = "n")
...
#Aceleración
histograma<-hist(bicis$aceleración_promedio, main="BP Aceleración Promedio", col="#DDA0DD", ylim=c(0,40), xlab="Aceleración (m/s²)",ylab="Frecuencia",  breaks = 15, xaxt = "n")
